...
def process_tone(syllable):
    ...
    if ((syllable.initial_class == 'mid' or syllable.initial_class == 'low') and syllable.live_dead == 'live' and not syllable.tone_mark):
        syllable.tone = 'mid'
    if (syllable.initial_class == 'high' and syllable.live_dead == 'dead' and not syllable.tone_mark) or \
        (syllable.initial_class == 'high' and syllable.live_dead == 'dead' and syllable.tone_mark == '่'):
        syllable.tone = 'low'
    if ((syllable.initial_class == 'mid' or syllable.initial_class == 'high') and syllable.tone_mark == '้') or \
        (syllable.initial_class == 'low' and syllable.tone_mark == '่'):
    ...
    if (syllable.initial_class == 'mid' and syllable.tone_mark == '๊') or \
        ...
        (syllable.initial_class == 'low' and syllable.live_dead == 'dead' and syllable.tone_mark == '้') or \
        (syllable.initial_class == 'low' and syllable.live_dead == 'dead' and not syllable.tone_mark):
        syllable.tone = 'high'
