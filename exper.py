...
for line in lines:
    ...
    y_row = [col for col in columns[1:] if col.strip() != '']  # Exclude empty elements
...
X_train_idx = [[word_to_idx.get(word, word_to_idx['<UNK>']) for word in sent] for sent in X_train]
...
class CRFModel(nn.Module):
    def __init__(self, num_tags, pad_idx):
        ...
        self.linear = nn.Linear(68, num_tags)  # Linear layer for emissions
